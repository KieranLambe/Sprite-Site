...
items_data = [
  ...
  { name: 'Minimalist Sprite', description: 'For those not looking to cause a splash. Truly the old money of sprite cans.', price: 10.00, star_rating: 5, image_filename: 'minimalist-sprite.png' },
